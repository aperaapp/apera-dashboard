...
import { o as o$3, t as t$2 } from './active-element-history-177Cd7sN.mjs';
import { o as o$2, b as u$4, q as c, p as f$1, w, h as t$1, j as i$1, f as f$1$1, r as E, u as u$1, A, T, i as i$5, s as s$1, e as i$3, N, m as l, y as i$1$1, x as u$2, O, c as o$1, H as n$1 } from './usePopper-C_2kou-4.mjs';
...
let ie = Symbol("VirtualContext"), Ae = defineComponent({ name: "VirtualProvider", setup(a, { slots: h$1 }) {
  ...
  let M = computed(() => a.multiple ? 1 : 0), $ = computed(() => a.nullable), [B, p] = d(computed(() => a.modelValue), (t2) => y("update:modelValue", t2), computed(() => a.defaultValue)), R = computed(() => B.value === void 0 ? u$4(M.value, { [1]: [], [0]: void 0 }) : B.value), V = null, i2 = null;
  function I(t2) {
  ...
  }, defaultValue: computed(() => a.defaultValue), nullable: $, immediate: computed(() => false), virtual: computed(() => null), inputRef: e$1, labelRef: u$22, buttonRef: c$1, optionsRef: f2, disabled: computed(() => a.disabled), options: v, change(t2) {
    p(t2);
  ...
  w([e$1, c$1, f2], () => l2.closeCombobox(), computed(() => o2.value === 0)), provide(ne, l2), t$1(computed(() => u$4(o2.value, { [0]: i$1.Open, [1]: i$1.Closed })));
  let g2 = computed(() => {
    var t2;
...
defineComponent({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r }) {
  var e2;
  let y = (e2 = a.id) != null ? e2 : `headlessui-combobox-label-${i$5()}`, o2 = K("ComboboxLabel");
  function u2() {
    var c2;
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r, expose: y }) {
  var S;
  let o2 = (S = a.id) != null ? S : `headlessui-combobox-button-${i$5()}`, u2 = K("ComboboxButton");
  ...
  let f2 = s$1(computed(() => ({ as: a.as, type: h2.type })), u2.buttonRef);
  return () => {
    var E2, w2;
  ...
  var V;
  let u$12 = (V = a.id) != null ? V : `headlessui-combobox-input-${i$5()}`, e2 = K("ComboboxInput"), c$1 = computed(() => i$3(o$2(e2.inputRef))), f2 = { value: false };
  ...
  function p(i2) {
    var T2, l2, g2;
    let I = (T2 = i2.relatedTarget) != null ? T2 : t$2.find((t2) => t2 !== i2.currentTarget);
    (l2 = o$2(e2.buttonRef)) != null && l2.contains(I) || (g2 = o$2(e2.optionsRef)) != null && g2.contains(I) || e2.disabled.value || e2.immediate.value && e2.comboboxState.value !== 0 && (e2.openCombobox(), o$3().nextFrame(() => {
  ...
  i$1$1({ container: computed(() => o$2(o2.optionsRef)), enabled: computed(() => o2.comboboxState.value === 0), accept(S) {
  ...
  let o2 = K("ComboboxOption"), u2 = `headlessui-combobox-option-${i$5()}`, e2 = ref(null), c$1 = computed(() => a.disabled);
  y({ el: e2, $el: e2 });
  let f2 = computed(() => {
    var p;
...
//# sourceMappingURL=combobox-BFxCJ4T7.mjs.map
