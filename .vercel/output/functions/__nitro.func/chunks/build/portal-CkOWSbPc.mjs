...
import { D as c$2, G as w$1, e as i$3, f as f$1, u as u$1, A, o as o$2 } from './usePopper-C_2kou-4.mjs';

function E(n2, e2, o2, r) {
  c$2.isServer || watchEffect((t) => {
...
function N({ defaultContainers: o$1 = [], portals: i$1, mainTreeNodeRef: H2 } = {}) {
  let t = ref(null), r = i$3(t);
  function u2() {
    var l, f2, a;
    let n2 = [];
    for (let e2 of o$1) e2 !== null && (e2 instanceof HTMLElement ? n2.push(e2) : "value" in e2 && e2.value instanceof HTMLElement && n2.push(e2.value));
    if (i$1 != null && i$1.value) for (let e2 of i$1.value) n2.push(e2);
    for (let e2 of (l = r == null ? void 0 : r.querySelectorAll("html > *, body > *")) != null ? l : []) e2 !== (void 0).body && e2 !== (void 0).head && e2 instanceof HTMLElement && e2.id !== "headlessui-portal-root" && (e2.contains(o$2(t)) || e2.contains((a = (f2 = o$2(t)) == null ? void 0 : f2.getRootNode()) == null ? void 0 : a.host) || n2.some((M2) => e2.contains(M2)) || n2.push(e2));
    return n2;
  }
...
let $ = defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e2, { slots: t, attrs: l }) {
  let r = ref(null), i$1 = computed(() => i$3(r)), o$1 = s(), u2 = inject(H, null), n2 = ref(o$1 === true || u2 == null ? x(r.value) : u2.resolveTarget());
...
//# sourceMappingURL=portal-CkOWSbPc.mjs.map
