import { m as mergeConfig, E as select, g as appConfig, F as selectMenu, f as __nuxt_component_0$2, a as __nuxt_component_1$3, h as useUI, B as useInjectButtonGroup, C as useDebounceFn, D as computedAsync, A as get, j as _export_sfc } from './server.mjs';
import { defineComponent, ref, computed, toRaw, provide, onMounted, watch, h as h$1, Fragment, onUnmounted, watchEffect, nextTick, toRef, useId, useSSRContext, inject, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, renderList, createTextVNode, Transition } from 'vue';
import { d, e, l as lt, n as nt, u as ut, r as rt, i as it } from './combobox-BFxCJ4T7.mjs';
import { b as u$4, p as f, q as c, w, k as w$2, l as h, o as o$2, h as t, j as i, f as f$1, r as E, u as u$1, A as A$1, T, i as i$5, s as s$1, m as l, N, v as p, x as u$2, n as usePopper, a as s$3, O, c as o$1 } from './usePopper-C_2kou-4.mjs';
import { q as defu, v as isEqual } from '../nitro/nitro.mjs';
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o$12, { slots: b, attrs: r, emit: w$2$1 }) {
  ...
  let D = computed(() => o$12.multiple ? 1 : 0), [y, L] = d(computed(() => o$12.modelValue), (t2) => w$2$1("update:modelValue", t2), computed(() => o$12.defaultValue)), M = computed(() => y.value === void 0 ? u$4(D.value, { [1]: [], [0]: void 0 }) : y.value), k = { listboxState: n, value: M, mode: D, compare(t2, i2) {
    ...
    let d2 = u$22(), O2 = f(t2 === c.Specific ? { focus: c.Specific, id: i2 } : { focus: t2 }, { resolveItems: () => d2.options, resolveActiveIndex: () => d2.activeOptionIndex, resolveId: (h2) => h2.id, resolveDisabled: (h2) => h2.dataRef.disabled });
    ...
    o$12.disabled || L(u$4(D.value, { [0]: () => t2, [1]: () => {
  ...
  w([f$2, v], (t2, i2) => {
    var l2;
    k.closeListbox(), w$2(i2, h.Loose) || (t2.preventDefault(), (l2 = o$2(f$2)) == null || l2.focus());
  }, computed(() => n.value === 0)), provide($, k), t(computed(() => u$4(n.value, { [0]: i.Open, [1]: i.Closed })));
  let C = computed(() => {
    var t2;
    return (t2 = o$2(f$2)) == null ? void 0 : t2.closest("form");
  });
  return onMounted(() => {
    watch([C], () => {
    ...
    return h$1(Fragment, [...t2 != null && M.value != null ? e({ [t2]: M.value }).map(([I, Q]) => h$1(f$1, E({ features: u$1.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, disabled: l2, name: I, value: Q }))) : [], A$1({ ourProps: {}, theirProps: { ...r, ...T(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h2, slots: b, attrs: r, name: "Listbox" })]);
  };
} });
defineComponent({ name: "ListboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(o$12, { attrs: b, slots: r }) {
  var f2;
  let w2 = (f2 = o$12.id) != null ? f2 : `headlessui-listbox-label-${i$5()}`, n = A("ListboxLabel");
  function e2() {
    var v;
...
let je = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o$2$1, { attrs: b, slots: r, expose: w2 }) {
  var p2;
  let n = (p2 = o$2$1.id) != null ? p2 : `headlessui-listbox-button-${i$5()}`, e2 = A("ListboxButton");
  ...
  let m = s$1(computed(() => ({ as: o$2$1.as, type: b.type })), e2.buttonRef);
  return () => {
    var y, L;
    let a = { open: e2.listboxState.value === 0, disabled: e2.disabled.value, value: e2.value.value }, { ...u2 } = o$2$1, D = { ref: e2.buttonRef, id: n, type: m.value, "aria-haspopup": "listbox", "aria-controls": (y = o$2(e2.optionsRef)) == null ? void 0 : y.id, "aria-expanded": e2.listboxState.value === 0, "aria-labelledby": e2.labelRef.value ? [(L = o$2(e2.labelRef)) == null ? void 0 : L.id, n].join(" ") : void 0, disabled: e2.disabled.value === true ? true : void 0, onKeydown: f2, onKeyup: v, onClick: s$12 };
  ...
  var p2;
  let n = (p2 = o$2$1.id) != null ? p2 : `headlessui-listbox-options-${i$5()}`, e2 = A("ListboxOptions"), f2 = ref(null);
  ...
  var C;
  let n = (C = o$12.id) != null ? C : `headlessui-listbox-option-${i$5()}`, e2 = A("ListboxOption"), f2 = ref(null);
  w2({ el: f2, $el: f2 });
  let v = computed(() => e2.activeOptionIndex.value !== null ? e2.options.value[e2.activeOptionIndex.value].id === n : false), s2 = computed(() => u$4(e2.mode.value, { [0]: () => e2.compare(toRaw(e2.value.value), toRaw(o$12.value)), [1]: () => toRaw(e2.value.value).some((t2) => e2.compare(toRaw(t2), toRaw(o$12.value))) })), m = computed(() => u$4(e2.mode.value, { [1]: () => {
    var i2;
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@2.20.0_change-case@5.4.4_magicast@0.3.5_rollup@4.28.1_typescript@5.7.2_vite@5.4.11_@_zc6sjfyp4c7evy7q42zrsrclzy/node_modules/@nuxt/ui/dist/runtime/components/forms/SelectMenu.vue");
...
//# sourceMappingURL=SelectMenu-CkXj8oEj.mjs.map
