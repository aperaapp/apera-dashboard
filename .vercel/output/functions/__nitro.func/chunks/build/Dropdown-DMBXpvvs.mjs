import { m as mergeConfig, O as dropdown, g as appConfig, f as __nuxt_component_0$2, a as __nuxt_component_1$3, h as useUI, N as getNuxtLinkProps, j as _export_sfc, n as __nuxt_component_1$5 } from './server.mjs';
import { _ as __nuxt_component_2 } from './Kbd-Yu76GohJ.mjs';
import { defineComponent, ref, computed, provide, onMounted, onUnmounted, watchEffect, nextTick, toRef, watch, useId, useSSRContext, inject, resolveComponent, mergeProps, withCtx, renderSlot, createVNode, resolveDynamicComponent, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, Transition } from 'vue';
import { w, k as w$2, l as h, o as o$2, h as t, b as u$4, j as i, A as A$1, i as i$5, s as s$1, y as i$1, m as l, N, v as p, x as u$2, n as usePopper, a as s$3, p as f, q as c, c as o$1, z as v$1, g as N$1, _, O as O$1 } from './usePopper-C_2kou-4.mjs';
...
let ge = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(o$12, { slots: M, attrs: i$12 }) {
  ...
  }, computed(() => I.value === 0)), provide(A, l2), t(computed(() => u$4(I.value, { [0]: i.Open, [1]: i.Closed }))), () => {
    let t2 = { open: I.value === 0, close: l2.closeMenu };
    return A$1({ ourProps: {}, theirProps: o$12, slot: t2, slots: M, attrs: i$12, name: "Menu" });
  };
} }), Se = defineComponent({ name: "MenuButton", props: { disabled: { type: Boolean, default: false }, as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o$2$1, { attrs: M, slots: i2, expose: I }) {
  var b;
  let p2 = (b = o$2$1.id) != null ? b : `headlessui-menu-button-${i$5()}`, e = O("MenuButton");
  ...
  let g = s$1(computed(() => ({ as: o$2$1.as, type: M.type })), e.buttonRef);
  return () => {
    var n;
    let l2 = { open: e.menuState.value === 0 }, { ...t2 } = o$2$1, a = { ref: e.buttonRef, id: p2, type: g.value, "aria-haspopup": "menu", "aria-controls": (n = o$2(e.itemsRef)) == null ? void 0 : n.id, "aria-expanded": e.menuState.value === 0, onKeydown: r, onKeyup: f2, onClick: d };
  ...
  var l$1;
  let p2 = (l$1 = o$2$1.id) != null ? l$1 : `headlessui-menu-items-${i$5()}`, e = O("MenuItems"), r = ref(null);
  I({ el: e.itemsRef, $el: e.itemsRef }), i$1({ container: computed(() => o$2(e.itemsRef)), enabled: computed(() => e.menuState.value === 0), accept(t2) {
  ...
  return () => {
    var s2, v2;
    let t2 = { open: e.menuState.value === 0 }, { ...a } = o$2$1, n = { "aria-activedescendant": e.activeItemIndex.value === null || (s2 = e.items.value[e.activeItemIndex.value]) == null ? void 0 : s2.id, "aria-labelledby": (v2 = o$2(e.buttonRef)) == null ? void 0 : v2.id, id: p2, onKeydown: f2, onKeyup: d, role: "menu", tabIndex: 0, ref: e.itemsRef };
  ...
  var v2;
  let p$1 = (v2 = o$12.id) != null ? v2 : `headlessui-menu-item-${i$5()}`, e = O("MenuItem"), r = ref(null);
  I({ el: r, $el: r });
...
const _sfc_main = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const NuxtLink = __nuxt_component_1$5;
    s$3(() => useId("$TEbheWlZuK"));
    return {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@2.20.0_change-case@5.4.4_magicast@0.3.5_rollup@4.28.1_typescript@5.7.2_vite@5.4.11_@_zc6sjfyp4c7evy7q42zrsrclzy/node_modules/@nuxt/ui/dist/runtime/components/elements/Dropdown.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]), { __name: "UDropdown" });

export { __nuxt_component_0 as _ };
//# sourceMappingURL=Dropdown-DMBXpvvs.mjs.map
